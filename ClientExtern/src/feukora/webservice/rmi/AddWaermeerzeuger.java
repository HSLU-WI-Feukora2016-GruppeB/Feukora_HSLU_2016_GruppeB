...
/**
 * <p>Java-Klasse für addWaermeerzeuger complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="addWaermeerzeuger">
 *   &lt;complexContent>
...
@XmlType(name = "addWaermeerzeuger", propOrder = {
    "waermeerzeuger"
})
public class AddWaermeerzeuger {
