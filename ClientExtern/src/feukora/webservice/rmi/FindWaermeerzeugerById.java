...
/**
 * <p>Java-Klasse für findWaermeerzeugerById complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="findWaermeerzeugerById">
 *   &lt;complexContent>
...
@XmlType(name = "findWaermeerzeugerById", propOrder = {
    "idWaermeerzeuger"
})
public class FindWaermeerzeugerById {
