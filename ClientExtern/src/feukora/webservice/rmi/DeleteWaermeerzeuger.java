...
/**
 * <p>Java-Klasse für deleteWaermeerzeuger complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="deleteWaermeerzeuger">
 *   &lt;complexContent>
...
@XmlType(name = "deleteWaermeerzeuger", propOrder = {
    "waermeerzeuger"
})
public class DeleteWaermeerzeuger {
