...
//	}
	...
	public void testFindByDatumAndMitarbeiterAndZeitslot() throws Exception {
		...
		GregorianCalendar d = new GregorianCalendar(2016, 9, 14);
		Mitarbeiter m = mitarbeiterDAO.findMitarbeiterByNameVorname("Stirnimann", "Dominik").get(0);
		int z = 1;
		assertNotNull(d);
		assertNotNull(m);
	...
	public static List<Auftrag> init() throws Exception {
		...
		lMitarbeiter.add(new Mitarbeiter("Pascal", "Steiner", "Musterstrasse 4", lOrt.get(2), "1234567678", "p.st@feukora.ch", 3, lBenutzer.get(2), 5000, new GregorianCalendar(2016, 05, 1), new GregorianCalendar(2018, 8, 11)));
		...
		lAuftrag.add(new Auftrag(lKontakt.get(0), lLiegenschaft.get(0), lMessung.get(0), lMessung.get(1), lMessung.get(2), lMessung.get(3), true, false, "Keine", lMitarbeiter.get(0), new GregorianCalendar(2016, 9, 7), 1, 1));
