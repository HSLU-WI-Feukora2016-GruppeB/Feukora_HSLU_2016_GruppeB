...
public class FeuerungsrapportServiceAuftragTest {
	...
	public static List<Auftrag> init() throws Exception {
		...
		List<Waermeerzeuger> lWaermeerzeugerDB = fservice.findAllWaermeerzeuger();
		
		//3 Feuerungsanlagen
		lFeuerungsanlage.add(new Feuerungsanlage(lBrennerDB.get(0), lWaermeerzeugerDB.get(0), 65));
		lFeuerungsanlage.add(new Feuerungsanlage(lBrennerDB.get(1), lWaermeerzeugerDB.get(1), 46));
		lFeuerungsanlage.add(new Feuerungsanlage(lBrennerDB.get(2), lWaermeerzeugerDB.get(2), 88));
		
		for(Feuerungsanlage f : lFeuerungsanlage){
			fservice.addFeuerungsanlage(f);
		}
		
		List<Feuerungsanlage> lFeuerungsanlageDB = fservice.findAllFeuerungsanlage();
		...
		lKontakt.add(new Kontakt("Martina", "Meyer", "Altstrasse 1", lOrtDB.get(2), "0633335577", "m.m@gmail.com", 2));
		lKontakt.add(new Kontakt("Christoph", "Müller", "Neustrasse 1", lOrtDB.get(6), "0554445577", "c.m@gmail.com", 1));
		lKontakt.add(new Kontakt("Heiri", "Muster", "Bernstrasse 1", lOrtDB.get(4), "0688885577", "h.m@gmail.com", 2));
		lKontakt.add(new Kontakt("Christof", "Meyer", "Gassweg 1", lOrtDB.get(5), "0633335577", "ch.m@gmail.com", 2));
		lKontakt.add(new Kontakt("Hanna", "Putz", "Malweg 5", lOrtDB.get(4), "0637777777", "h.p@gmail.com", 2));
		lKontakt.add(new Kontakt("Martina", "Zäh", "Altstrasse 90", lOrtDB.get(3), "0633888877", "m.z@gmail.com", 2));
		lKontakt.add(new Kontakt("Tina", "Bär", "Waserstrasse 4", lOrtDB.get(5), "0222235577", "t.b@gmail.com", 1));
		lKontakt.add(new Kontakt("Rudolf", "Santa", "Zaubergass 7", lOrtDB.get(1), "0699999997", "r.s@gmail.com", 2));
		...
		lLiegenschaft.add(new Liegenschaft(lKontaktDB.get(0), "Hausmeister bei Muster klingeln", "Abcweg 123", lOrtDB.get(3),lFeuerungsanlageDB.get(0)));
		lLiegenschaft.add(new Liegenschaft(lKontaktDB.get(1), "07978885599 anrufen bei Ankunft", "Musterweg 456", lOrtDB.get(4),lFeuerungsanlageDB.get(1)));
		lLiegenschaft.add(new Liegenschaft(lKontaktDB.get(2), "Türe ist offen", "Musterweg 456", lOrtDB.get(5),lFeuerungsanlageDB.get(2)));
		...
		lMitarbeiter.add(new Mitarbeiter("Olivia", "Wassmer", "Musterstrasse 1", lOrtDB.get(3), "1234567678", "o.w@feukora.ch", 1, lBenutzerDB.get(5), 5000, new GregorianCalendar(2016, 05, 1), new GregorianCalendar(2018, 8, 11)));
		lMitarbeiter.add(new Mitarbeiter("Matthias", "Perrollaz", "Musterstrasse 2", lOrtDB.get(4), "1234557678", "m.p@feukora.ch", 2, lBenutzerDB.get(4), 5000, new GregorianCalendar(2016, 05, 1), new GregorianCalendar(2018, 8, 11)));
		lMitarbeiter.add(new Mitarbeiter("Dominik", "Stirnimann", "Musterstrasse 3", lOrtDB.get(3), "1234367678", "d.s@feukora.ch", 1, lBenutzerDB.get(3), 5000, new GregorianCalendar(2016, 05, 1), new GregorianCalendar(2018, 8, 11)));
		lMitarbeiter.add(new Mitarbeiter("Pascal", "Steiner", "Musterstrasse 4", lOrtDB.get(2), "1234567678", "p.st@feukora.ch", 1, lBenutzerDB.get(2), 5000, new GregorianCalendar(2016, 05, 1), new GregorianCalendar(2018, 8, 11)));
		lMitarbeiter.add(new Mitarbeiter("Luca", "Raneri", "Musterstrasse 5", lOrtDB.get(1), "1234567178", "l.r@feukora.ch", 1, lBenutzerDB.get(1), 5000, new GregorianCalendar(2016, 05, 1), new GregorianCalendar(2018, 8, 11)));
		lMitarbeiter.add(new Mitarbeiter("Alexandra", "Lengen", "Musterstrasse 1", lOrtDB.get(0), "1234563678", "a.l@feukora.ch", 1, lBenutzerDB.get(5), 5000, new GregorianCalendar(2016, 05, 1), new GregorianCalendar(2018, 8, 11)));
		...
		lAuftrag.add(new Auftrag(lKontaktDB.get(0), lLiegenschaftDB.get(0), lMessungDB.get(0), lMessungDB.get(1), lMessungDB.get(2), lMessungDB.get(3), true, false, "Keine", lMitarbeiterDB.get(0), new GregorianCalendar(2016, 9, 11), 1, 1));
		lAuftrag.add(new Auftrag(lKontaktDB.get(1), lLiegenschaftDB.get(1), lMessungDB.get(4), lMessungDB.get(2), lMessungDB.get(5), lMessungDB.get(3), true, false, "Bekommen demnächst neue Heizung", lMitarbeiterDB.get(2), new GregorianCalendar(2016, 9, 18), 1, 1));
		lAuftrag.add(new Auftrag(lKontaktDB.get(2), lLiegenschaftDB.get(1), lMessungDB.get(6), lMessungDB.get(7), lMessungDB.get(8), lMessungDB.get(9), false, true, "Komplett verrostet, geht nicht ohne neue Anlage", lMitarbeiterDB.get(3), new GregorianCalendar(2016, 9, 11), 2, 2));
