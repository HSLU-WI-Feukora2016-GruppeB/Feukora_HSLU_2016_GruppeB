...
//	/**
//	 * Dieser Test tested die Methode {@link FeuerungsrapportServiceImpl#updateWaermeerzeuger(entitys.Waermeerzeuger)}.
//	 * @throws Exception
//	 */
//	@Test
//	public void testUpdateWaermeerzeuger() throws Exception{
//		
//		List<Waermeerzeuger> waermeerzeugerListe = fservice.findAllWaermeerzeuger();
...
//
//	/**
//	 * Dieser Test tested die Methode {@link FeuerungsrapportServiceImpl#findAllWaermeerzeuger()}.
//	 * @throws Exception
//	 */
//	@Test
...
//
//	/**
//	 * Dieser Test tested die Methode {@link FeuerungsrapportServiceImpl#findWaermeerzeugerByTyp(String)}.
//	 * @throws Exception
//	 */
//	@Test
...
//		String typ = "qwertz";
//		
//		List<Waermeerzeuger> waermeerzeugerListe = fservice.findWaermeerzeugerByTyp(typ);
//		assertTrue(waermeerzeugerListe.size() == 1);
//	}
//
//	/**
//	 * Dieser Test tested die Methode {@link FeuerungsrapportServiceImpl#findWaermeerzeugerByBrennstoff(int)}.
//	 * @throws Exception
//	 */
//	@Test
...
//		int brennstoff = 2;
//		
//		List<Waermeerzeuger> waermeerzeugerListe = fservice.findWaermeerzeugerByBrennstoff(brennstoff);
//		assertTrue(waermeerzeugerListe.size() == 1);
//	}

	/**
	 * Dieser Test tested die Methode {@link FeuerungsrapportServiceImpl#findWaermeerzeugerByBaujahr(int)}.
	 * @throws Exception
	 */
	@Test
	public void testFindWaermeerzeugerByBaujahr() throws Exception {
		...
		List<Waermeerzeuger> waermeerzeugerListe = fservice.findWaermeerzeugerByBaujahr(baujahr);
		assertTrue(waermeerzeugerListe.size() == 1);
	}

//	/**
//	 * Dieser Test tested die Methode {@link FeuerungsrapportServiceImpl#deleteWaermeerzeuger(entitys.Waermeerzeuger)}.
//	 * @throws Exception
//	 */
//	@Test
...
//
//	/**
//	 * Dieser Test tested die Methode {@link FeuerungsrapportServiceImpl#deleteWaermeerzeugerById(Integer)}.
//	 * @throws Exception
//	 */
//	@Test
...
//		assertTrue(waermeerzeugerListe.size() == 3);
//
//		fservice.deleteWaermeerzeugerById(waermeerzeugerListe.get(0).getIdWaermeerzeuger());
//
//		waermeerzeugerListe = fservice.findAllWaermeerzeuger();
//		assertTrue(waermeerzeugerListe.size() == 2);
//	}
