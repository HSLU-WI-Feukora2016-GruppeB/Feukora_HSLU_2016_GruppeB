...
public class FeuerungsrapportServiceMitarbeiterTest {
	 ...
	 * {@link FeuerungsrapportServiceImpl#updateMitarbeiter(Mitarbeiter)}.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#findAllMitarbeiter()}.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#findMitarbeiterByName(String)}.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testFindMitarbeiterByName() throws Exception {
		...
		String name = "Raneri";
		List<Mitarbeiter> mitarbeiterListe = fservice
				.findMitarbeiterByName(name);
		assertTrue(mitarbeiterListe.size() == 1);
	}

	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#findMitarbeiterByVorname(String)}.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#findMitarbeiterByNameVorname(String, String)}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#findMitarbeiterByStrasse(String)}.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testFindMitarbeiterByStrasse() throws Exception {
		...
		List<Mitarbeiter> mitarbeiterListe = fservice
				.findMitarbeiterByStrasse(strasse);
		assertTrue(mitarbeiterListe.size() == 1);
	}

	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#findMitarbeiterByOrt(Ort)}.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testFindMitarbeiterByOrt() throws Exception {
		...
		List<Mitarbeiter> mitarbeitersListe = fservice
				.findMitarbeiterByOrt(ort);
		assertTrue(mitarbeitersListe.size() == 1);
	}

	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#findMitarbeiterByRolleIntern(int)}.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testFindMitarbeiterByRolleIntern() throws Exception {
		...
		List<Mitarbeiter> mitarbeiterListe = fservice
				.findMitarbeiterByRolleIntern(rolleIntern);
		assertTrue(mitarbeiterListe.size() == 5);
	}

	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#findMitarbeiterByBenutzer(Benutzer)}.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testFindMitarbeiterByBenutzer() throws Exception {
		...
		List<Mitarbeiter> mitarbeitersListe = fservice
				.findMitarbeiterByBenutzer(benutzer);
		assertTrue(mitarbeitersListe.size() == 1);
	}
	...
	public void testFindMitarbeiterByArbeitetSeit() throws Exception {
		...
		List<Mitarbeiter> mitarbeiterListe = fservice
				.findMitarbeiterByArbeitetSeit(seit);
	...
	public void testFindMitarbeiterByArbeitetBis() throws Exception {
		...
		List<Mitarbeiter> mitarbeiterListe = fservice
				.findMitarbeiterByArbeitetBis(bis);
		assertEquals(6, mitarbeiterListe.size());
	}

	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#deleteMitarbeiter(Mitarbeiter)}
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Dieser Test tested die Methode
	 * {@link FeuerungsrapportServiceImpl#deleteMitarbeiterById(Integer)}.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testDeleteMitarbeiterById() throws Exception {
		...
		fservice.deleteMitarbeiterById(mitarbeiterListe.get(0)
				.getIdMitarbeiter());
